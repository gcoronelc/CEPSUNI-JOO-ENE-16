...
public class MainView extends javax.swing.JFrame {
  ...
  private void menuMateFactorialActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuMateFactorialActionPerformed
    ...
    try {
      FactorialView view;
      view = (FactorialView) Class.forName("pe.egcc.mateexpert.view.FactorialView").newInstance();
  ...
  private void cargarFormulario(Class<?> aClass) {
    try {
      ...
      // Si no lo encuentra, se debe crear la instancia
      if(view == null){
  ...
  /**
   * Retorna el apuntador al formulario que es una instancia de la clase,
   * si no encuentra una instancia, retorna null.
   * 
   * @param aClass
   * @return 
   */
